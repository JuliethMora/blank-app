...
if run_button:
    ...
    with subprocess.Popen(
        ...
        for line in proc.stdout:
            logs.append(line)
            # Mostrar últimas líneas del log en Streamlit
    ...
    # --------------------------
    # Mostrar y permitir descargar los resultados
    # --------------------------
    ...
    if not all_outputs:
        ...
        # Filtrar archivos con 'output' en el nombre
        ...
        # Crear archivo ZIP con hasta 3 outputs
